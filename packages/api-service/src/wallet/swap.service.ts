...
export class SwapService {
  async getPrice(tokenAddress: string): Promise<number> {
    const mockPrices: Record<string, number> = {
      ...
      // Test tokens
      '0x1111111111111111111111111111111111111111111111111111111111111111': 1.0, // TUSDC (stablecoin)
      '0x2222222222222222222222222222222222222222222222222222222222222222': 3000.0, // TETH
      '0x3333333333333333333333333333333333333333333333333333333333333333': 60000.0, // TBTC
      '0x4444444444444444444444444444444444444444444444444444444444444444': 1.0, // TDAI (stablecoin)
    };
